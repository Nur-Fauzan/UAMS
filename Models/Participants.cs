...
public partial class UAMS_20250216_1835 {
    ...
    {
        get => HttpData.Resolve<Participants>("Participants");
        set => HttpData["Participants"] = value;
    }

    /// <summary>
    /// Table class for Participants
    /// </summary>
    public class Participants : DbTable
    {
        ...
        public readonly DbField<SqlDbType> AppointmentId;
        ...
        public Participants()
        {
            ...
            Name = "Participants";
            Type = "TABLE";
            UpdateTable = "dbo.Participants"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            UserId = new(this, "x_UserId", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("Participants", "UserId", "CustomMsg"),
                IsUpload = false
            };
            UserId.Raw = true;
            UserId.Lookup = new Lookup<DbField>(UserId, "Users", false, "Id", new List<string> {"Username", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, false, "", "", "[Username]");
            Fields.Add("UserId", UserId);

            // AppointmentId
            AppointmentId = new(this, "x_AppointmentId", 3, SqlDbType.Int) {
                Name = "AppointmentId",
                Expression = "[AppointmentId]",
                BasicSearchExpression = "CAST([AppointmentId] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[AppointmentId]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("Participants", "AppointmentId", "CustomMsg"),
                IsUpload = false
            };
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.Participant type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                AppointmentId.DbValue = row["AppointmentId"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "ParticipantsView" => Language.Phrase("View"),
                "ParticipantsEdit" => Language.Phrase("Edit"),
                "ParticipantsAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "ParticipantsView",
                Config.ApiAddAction => "ParticipantsAdd",
                Config.ApiEditAction => "ParticipantsEdit",
                Config.ApiDeleteAction => "ParticipantsDelete",
                Config.ApiListAction => "ParticipantsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "ParticipantsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("ParticipantsView", parm);
            else
                url = KeyUrl("ParticipantsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "ParticipantsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("ParticipantsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("ParticipantsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("ParticipantsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("ParticipantsList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("ParticipantsDelete", parm)); // DN
        }
        ...
        {
            string pageName = "ParticipantsList";
