...
public partial class project1 {
    ...
    /// </summary>
    [MaybeNull]
    public static RefreshTokens refreshTokens
    {
        get => HttpData.Resolve<RefreshTokens>("RefreshTokens");
        set => HttpData["RefreshTokens"] = value;
    }

    /// <summary>
    /// Table class for RefreshTokens
    /// </summary>
    public class RefreshTokens : DbTable
    {
        ...
        public readonly DbField<SqlDbType> _Token;

        public readonly DbField<SqlDbType> ExpiryDate;
        ...
        public RefreshTokens()
        {
            ...
            Name = "RefreshTokens";
            Type = "TABLE";
            UpdateTable = "dbo.RefreshTokens"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("RefreshTokens", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            UserId = new(this, "x_UserId", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("RefreshTokens", "UserId", "CustomMsg"),
                IsUpload = false
            };
            UserId.Raw = true;
            ...
            // Token
            _Token = new(this, "x__Token", 202, SqlDbType.NVarChar) {
                Name = "Token",
                Expression = "[Token]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Token]",
                DateTimeFormat = -1,
                VirtualExpression = "[Token]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("RefreshTokens", "_Token", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Token", _Token);

            // ExpiryDate
            ExpiryDate = new(this, "x_ExpiryDate", 135, SqlDbType.DateTime) {
                Name = "ExpiryDate",
                Expression = "[ExpiryDate]",
                BasicSearchExpression = CastDateFieldForLike("[ExpiryDate]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[ExpiryDate]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
        ...
        {
            get => _sqlFrom ?? "dbo.RefreshTokens";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.RefreshToken type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                _Token.DbValue = row["Token"]; // Set DB value only
                ExpiryDate.DbValue = row["ExpiryDate"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "RefreshTokensView" => Language.Phrase("View"),
                "RefreshTokensEdit" => Language.Phrase("Edit"),
                "RefreshTokensAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "RefreshTokensView",
                Config.ApiAddAction => "RefreshTokensAdd",
                Config.ApiEditAction => "RefreshTokensEdit",
                Config.ApiDeleteAction => "RefreshTokensDelete",
                Config.ApiListAction => "RefreshTokensList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "RefreshTokensList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("RefreshTokensView", parm);
            else
                url = KeyUrl("RefreshTokensView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "RefreshTokensAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "RefreshTokensAdd?" + parm;
            else
                url = "RefreshTokensAdd";
        ...
        {
            string url = "";
            url = KeyUrl("RefreshTokensEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("RefreshTokensList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("RefreshTokensAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("RefreshTokensList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("RefreshTokensDelete", parm)); // DN
        }
        ...
        {
            string pageName = "RefreshTokensList";
        ...
        public async Task RenderEditRow()
        {
            ...
            _Token.EditValue = _Token.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(_Token);
                        doc.ExportCaption(ExpiryDate);
                    } else {
                        doc.ExportCaption(Id);
                        doc.ExportCaption(UserId);
                        doc.ExportCaption(_Token);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(_Token);
                            await doc.ExportField(ExpiryDate);
                        } else {
                            await doc.ExportField(Id);
                            await doc.ExportField(UserId);
                            await doc.ExportField(_Token);
