...
public partial class UAMS_20250216_1835 {
    ...
    /// appointmentsView
    /// </summary>
    public static AppointmentsView appointmentsView
    {
        get => HttpData.Get<AppointmentsView>("appointmentsView")!;
        set => HttpData["appointmentsView"] = value;
    }

    /// <summary>
    /// Page class for Appointments
    /// </summary>
    public class AppointmentsView : AppointmentsViewBase
    {
        // Constructor
        public AppointmentsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AppointmentsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AppointmentsViewBase : Appointments
    {
        // Page ID
        ...
        // Page name
        public string PageName => "AppointmentsView";
        ...
        // Constructor
        public AppointmentsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("AppointmentsList"); // Return to list page
                            }
                        }
                    break;
            }
