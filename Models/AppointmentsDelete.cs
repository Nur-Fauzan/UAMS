...
public partial class project1 {
    ...
    /// appointmentsDelete
    /// </summary>
    public static AppointmentsDelete appointmentsDelete
    {
        get => HttpData.Get<AppointmentsDelete>("appointmentsDelete")!;
        set => HttpData["appointmentsDelete"] = value;
    }

    /// <summary>
    /// Page class for Appointments
    /// </summary>
    public class AppointmentsDelete : AppointmentsDeleteBase
    {
        // Constructor
        public AppointmentsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AppointmentsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AppointmentsDeleteBase : Appointments
    {
        // Page ID
        ...
        // Page name
        public string PageName => "AppointmentsDelete";
        ...
        // Constructor
        public AppointmentsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("AppointmentsList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("AppointmentsList"); // Return to list
                }
            }
