...
public partial class UAMS_20250216_1835 {
    ...
    /// participantsDelete
    /// </summary>
    public static ParticipantsDelete participantsDelete
    {
        get => HttpData.Get<ParticipantsDelete>("participantsDelete")!;
        set => HttpData["participantsDelete"] = value;
    }

    /// <summary>
    /// Page class for Participants
    /// </summary>
    public class ParticipantsDelete : ParticipantsDeleteBase
    {
        // Constructor
        public ParticipantsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ParticipantsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ParticipantsDeleteBase : Participants
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "participantsDelete";
        ...
        // Page name
        public string PageName => "ParticipantsDelete";
        ...
        // Constructor
        public ParticipantsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("ParticipantsList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("ParticipantsList"); // Return to list
                }
            }
