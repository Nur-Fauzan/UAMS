...
public partial class UAMS_20250216_1835 {
    ...
    /// timezonesView
    /// </summary>
    public static TimezonesView timezonesView
    {
        get => HttpData.Get<TimezonesView>("timezonesView")!;
        set => HttpData["timezonesView"] = value;
    }

    /// <summary>
    /// Page class for Timezones
    /// </summary>
    public class TimezonesView : TimezonesViewBase
    {
        // Constructor
        public TimezonesView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TimezonesView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TimezonesViewBase : Timezones
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "timezonesView";
        ...
        public TimezonesViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["TimezoneID"] = keys[0];
            } else {
                RecordKeys["TimezoneID"] = RouteValues.TryGetValue("TimezoneID", out obj) && obj != null ? UrlDecode(obj) : Get("TimezoneID"); // DN
            }
        ...
        // Page name
        public string PageName => "TimezonesView";
        ...
        // Constructor
        public TimezonesViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("TimezoneID", out v) && !Empty(v)) { // DN
                TimezoneID.QueryValue = UrlDecode(v); // DN
                RecordKeys["TimezoneID"] = TimezoneID.QueryValue;
            } else if (Get("TimezoneID", out sv)) {
                TimezoneID.QueryValue = sv.ToString();
                RecordKeys["TimezoneID"] = TimezoneID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                TimezoneID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["TimezoneID"] = TimezoneID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "TimezonesList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TimezonesList"); // Return to list page
                            }
                        }
                    break;
            }
