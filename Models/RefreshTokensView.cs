...
public partial class UAMS_20250216_1835 {
    ...
    /// refreshTokensView
    /// </summary>
    public static RefreshTokensView refreshTokensView
    {
        get => HttpData.Get<RefreshTokensView>("refreshTokensView")!;
        set => HttpData["refreshTokensView"] = value;
    }

    /// <summary>
    /// Page class for RefreshTokens
    /// </summary>
    public class RefreshTokensView : RefreshTokensViewBase
    {
        // Constructor
        public RefreshTokensView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RefreshTokensView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RefreshTokensViewBase : RefreshTokens
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "refreshTokensView";
        ...
        // Page name
        public string PageName => "RefreshTokensView";
        ...
        // Constructor
        public RefreshTokensViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("RefreshTokensList"); // Return to list page
                            }
                        }
                    break;
            }
