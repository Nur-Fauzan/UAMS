...
public partial class UAMS_20250216_1835 {
    ...
    /// refreshTokensDelete
    /// </summary>
    public static RefreshTokensDelete refreshTokensDelete
    {
        get => HttpData.Get<RefreshTokensDelete>("refreshTokensDelete")!;
        set => HttpData["refreshTokensDelete"] = value;
    }

    /// <summary>
    /// Page class for RefreshTokens
    /// </summary>
    public class RefreshTokensDelete : RefreshTokensDeleteBase
    {
        // Constructor
        public RefreshTokensDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RefreshTokensDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RefreshTokensDeleteBase : RefreshTokens
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "refreshTokensDelete";
        ...
        // Constructor
        public RefreshTokensDeleteBase()
        {
        ...
        // Constructor
        public RefreshTokensDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("RefreshTokensList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("RefreshTokensList"); // Return to list
                }
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                refreshTokensDelete?.PageRender();
            }
            return PageResult();
        }
