...
public partial class project1 {
    ...
    /// appointmentsEdit
    /// </summary>
    public static AppointmentsEdit appointmentsEdit
    {
        get => HttpData.Get<AppointmentsEdit>("appointmentsEdit")!;
        set => HttpData["appointmentsEdit"] = value;
    }

    /// <summary>
    /// Page class for Appointments
    /// </summary>
    public class AppointmentsEdit : AppointmentsEditBase
    {
        // Constructor
        public AppointmentsEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AppointmentsEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AppointmentsEditBase : Appointments
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "appointmentsEdit";
        ...
        // Page name
        public string PageName => "AppointmentsEdit";
        ...
        // Constructor
        public AppointmentsEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("AppointmentsList"); // No matching record, return to list
                        }
                    break;
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // StartTime
            _StartTime.SetDbValue(rsnew, ConvertToDateTime(_StartTime.CurrentValue, _StartTime.FormatPattern), _StartTime.ReadOnly);

            // EndTime
            EndTime.SetDbValue(rsnew, ConvertToDateTime(EndTime.CurrentValue, EndTime.FormatPattern), EndTime.ReadOnly);

            // CreatedBy
            CreatedBy.SetDbValue(rsnew, CreatedBy.CurrentValue, CreatedBy.ReadOnly);

            // Timezone
            Timezone.SetDbValue(rsnew, Timezone.CurrentValue, Timezone.ReadOnly);
            return rsnew;
        }
