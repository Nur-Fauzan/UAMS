...
public partial class UAMS_20250216_1835 {
    ...
    /// participantsEdit
    /// </summary>
    public static ParticipantsEdit participantsEdit
    {
        get => HttpData.Get<ParticipantsEdit>("participantsEdit")!;
        set => HttpData["participantsEdit"] = value;
    }

    /// <summary>
    /// Page class for Participants
    /// </summary>
    public class ParticipantsEdit : ParticipantsEditBase
    {
        // Constructor
        public ParticipantsEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ParticipantsEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ParticipantsEditBase : Participants
    {
        // Page ID
        ...
        // Page name
        public string PageName => "ParticipantsEdit";
        ...
        // Constructor
        public ParticipantsEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("ParticipantsList"); // No matching record, return to list
                        }
                    break;
        ...
        protected Dictionary<string, object> GetEditRow(Dictionary<string, object> rsold)
        {
            ...
            // AppointmentId
            AppointmentId.SetDbValue(rsnew, AppointmentId.CurrentValue, AppointmentId.ReadOnly);
        ...
        protected void RestoreEditFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("AppointmentId", out value)) // AppointmentId
                AppointmentId.CurrentValue = value;
