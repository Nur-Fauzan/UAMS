...
public partial class UAMS_20250216_1835 {
    ...
    {
        get => HttpData.Resolve<Appointments>("Appointments");
        set => HttpData["Appointments"] = value;
    }

    /// <summary>
    /// Table class for Appointments
    /// </summary>
    public class Appointments : DbTable
    {
        ...
        public readonly DbField<SqlDbType> _StartTime;

        public readonly DbField<SqlDbType> EndTime;
        ...
        public Appointments()
        {
            ...
            Name = "Appointments";
            Type = "TABLE";
            UpdateTable = "dbo.Appointments"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new(this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Appointments", "Id", "CustomMsg"),
                IsUpload = false
            };
            Id.Raw = true;
            Fields.Add("Id", Id);
            ...
            _Title = new(this, "x__Title", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Appointments", "_Title", "CustomMsg"),
                IsUpload = false
            };
            ...
            Description = new(this, "x_Description", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("Appointments", "Description", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Description", Description);

            // StartTime
            _StartTime = new(this, "x__StartTime", 135, SqlDbType.DateTime) {
                Name = "StartTime",
                Expression = "[StartTime]",
                BasicSearchExpression = CastDateFieldForLike("[StartTime]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[StartTime]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("Appointments", "_StartTime", "CustomMsg"),
                IsUpload = false
            };
            _StartTime.Raw = true;
            Fields.Add("StartTime", _StartTime);

            // EndTime
            EndTime = new(this, "x_EndTime", 135, SqlDbType.DateTime) {
                Name = "EndTime",
                Expression = "[EndTime]",
                BasicSearchExpression = CastDateFieldForLike("[EndTime]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[EndTime]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("Appointments", "EndTime", "CustomMsg"),
                IsUpload = false
            };
            EndTime.Raw = true;
            Fields.Add("EndTime", EndTime);
            ...
            CreatedBy = new(this, "x_CreatedBy", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"],
                CustomMessage = Language.FieldPhrase("Appointments", "CreatedBy", "CustomMsg"),
                IsUpload = false
            };
            CreatedBy.Raw = true;
            ...
            // Timezone
            Timezone = new(this, "x_Timezone", 202, SqlDbType.NVarChar) {
                Name = "Timezone",
                Expression = "[Timezone]",
                UseBasicSearch = true,
                ...
                Required = true, // Required field
                SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"],
                CustomMessage = Language.FieldPhrase("Appointments", "Timezone", "CustomMsg"),
                IsUpload = false
            };
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            if (data is IDictionary<string, object> d)
                ...
                throw new ArgumentException("Data must be of anonymous or Dictionary<string, object> or Entities.Appointment type", "data");
            row = row.Where(kvp => {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                _StartTime.DbValue = row["StartTime"]; // Set DB value only
                EndTime.DbValue = row["EndTime"]; // Set DB value only
        ...
        public string GetModalCaption(string pageName)
        {
            return pageName switch {
                "AppointmentsView" => Language.Phrase("View"),
                "AppointmentsEdit" => Language.Phrase("Edit"),
                "AppointmentsAdd" => Language.Phrase("Add"),
                _ => String.Empty
            };
        }
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "AppointmentsView",
                Config.ApiAddAction => "AppointmentsAdd",
                Config.ApiEditAction => "AppointmentsEdit",
                Config.ApiDeleteAction => "AppointmentsDelete",
                Config.ApiListAction => "AppointmentsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "AppointmentsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("AppointmentsView", parm);
            else
                url = KeyUrl("AppointmentsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "AppointmentsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("AppointmentsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("AppointmentsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("AppointmentsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("AppointmentsList", "action=copy"))); // DN
        ...
        public string GetDeleteUrl(string parm = "")
        {
            return UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
                ...
                : AppPath(KeyUrl("AppointmentsDelete", parm)); // DN
        }
        ...
        {
            string pageName = "AppointmentsList";
        ...
        public async Task RenderEditRow()
        {
            ...
            _Title.EditValue = _Title.CurrentValue;
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(_StartTime);
                        doc.ExportCaption(EndTime);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(_StartTime);
                            await doc.ExportField(EndTime);
