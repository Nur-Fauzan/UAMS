...
public partial class project1 {
    ...
    /// refreshTokensAdd
    /// </summary>
    public static RefreshTokensAdd refreshTokensAdd
    {
        get => HttpData.Get<RefreshTokensAdd>("refreshTokensAdd")!;
        set => HttpData["refreshTokensAdd"] = value;
    }

    /// <summary>
    /// Page class for RefreshTokens
    /// </summary>
    public class RefreshTokensAdd : RefreshTokensAddBase
    {
        // Constructor
        public RefreshTokensAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RefreshTokensAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RefreshTokensAddBase : RefreshTokens
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "refreshTokensAdd";
        ...
        // Page name
        public string PageName => "RefreshTokensAdd";
        ...
        // Constructor
        public RefreshTokensAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("RefreshTokensList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "RefreshTokensView")
        ...
        protected Dictionary<string, object> GetAddRow()
        {
            try {
                ...
                // Token
                _Token.SetDbValue(rsnew, _Token.CurrentValue);

                // ExpiryDate
                ExpiryDate.SetDbValue(rsnew, ConvertToDateTime(ExpiryDate.CurrentValue, ExpiryDate.FormatPattern));
                return rsnew;
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
        ...
        private void RestoreAddFormFromRow(Dictionary<string, object> row)
        {
            ...
            if (row.TryGetValue("Token", out value)) // Token
                _Token.SetFormValue(ConvertToString(value));
            if (row.TryGetValue("ExpiryDate", out value)) // ExpiryDate
                ExpiryDate.SetFormValue(ConvertToString(value));
        }
