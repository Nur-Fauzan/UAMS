...
public partial class UAMS_20250216_1835 {
    ...
    /// participantsView
    /// </summary>
    public static ParticipantsView participantsView
    {
        get => HttpData.Get<ParticipantsView>("participantsView")!;
        set => HttpData["participantsView"] = value;
    }

    /// <summary>
    /// Page class for Participants
    /// </summary>
    public class ParticipantsView : ParticipantsViewBase
    {
        // Constructor
        public ParticipantsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ParticipantsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class ParticipantsViewBase : Participants
    {
        // Page ID
        ...
        // Page name
        public string PageName => "ParticipantsView";
        ...
        // Constructor
        public ParticipantsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "ParticipantsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("ParticipantsList"); // Return to list page
                            }
                        }
                    break;
            }
